                ...
                <div class="form-body">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="email" class="form-control" type="email" name="email" pattern="[a-zA-Z0-9._%+-]+@gmail\.com" title="Masukkan alamat email Gmail yang valid" value="{{ old('email') }}" required>
                        </div>
                        <div class="mb-3">
